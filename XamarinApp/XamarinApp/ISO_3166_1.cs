...
namespace XamarinApp
{
	...
	public static class ISO_3166_1
	{
		...
		static ISO_3166_1()
		{
			foreach (KeyValuePair<string, string> P in countryByCode)
				codeByCountry[P.Value] = P.Key;
		}
		...
		public static string[] Codes
		{
			get
			{
				string[] Result = new string[countryByCode.Count];
				countryByCode.Keys.CopyTo(Result, 0);
				return Result;
			}
		}
		...
		public static string[] Countries
		{
			get
			{
				string[] Result = new string[codeByCountry.Count];
				codeByCountry.Keys.CopyTo(Result, 0);
				return Result;
			}
		}
